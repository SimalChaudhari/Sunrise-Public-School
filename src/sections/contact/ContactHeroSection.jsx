import { ContactPhonebookIcon } from '../../icons'
  ...
  return (
    <section className="relative left-1/2 right-1/2 ml-[-50vw] mr-[-50vw] w-screen overflow-hidden bg-slate-950 py-40 text-center">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <ContactPhonebookIcon className="text-2xl text-blue-300" />
        ...
        >
          Reach our admissions and administration team for support, enrollment, and campus-related information.
        </p>
      </div>
    </section>
  )
