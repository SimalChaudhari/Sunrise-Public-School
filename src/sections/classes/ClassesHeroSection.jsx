  ...
  return (
    <section className="relative left-1/2 right-1/2 ml-[-50vw] mr-[-50vw] w-screen overflow-hidden bg-slate-950 py-40 text-center">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <ClassesIcon className="h-4 w-4 text-blue-300" />
          Class Operations
        </div>
        ...
        >
          Monitor class-wise allocation, class teacher ownership, room details, and student strength.
        </p>
      </div>
    </section>
  )
