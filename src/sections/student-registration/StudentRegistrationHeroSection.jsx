import { StudentRegisterIcon } from '../../icons'

function StudentRegistrationHeroSection() {
  return (
    <section className="relative left-1/2 right-1/2 ml-[-50vw] mr-[-50vw] w-screen overflow-hidden bg-slate-950 py-40 text-center">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <StudentRegisterIcon className="h-4 w-4 text-blue-300" />
          Admissions Desk
        </div>
        ...
        >
          Register new students with personal details, class preferences, and guardian information.
        </p>
      </div>
    </section>
  )
