import { SubjectsIcon } from '../../icons'

function SubjectsHeroSection() {
  return (
    <section className="relative left-1/2 right-1/2 ml-[-50vw] mr-[-50vw] w-screen overflow-hidden bg-slate-950 py-40 text-center">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <SubjectsIcon className="h-4 w-4 text-blue-300" />
        ...
        >
          Explore all subjects by standard with assigned teachers and weekly period distribution.
        </p>
      </div>
    </section>
  )
...
export default SubjectsHeroSection
